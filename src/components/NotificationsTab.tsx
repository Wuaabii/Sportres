...
import { Bell, CheckCircle2, MapPin, MessageSquare, Trash2, Trophy } from 'lucide-react';
...
export const NotificationsTab: React.FC = () => {
  ...
  return (
    <div id="notifications-tab-content" className="flex-1 flex flex-col overflow-hidden select-none animate-fadeIn bg-neutral-50 p-4 space-y-3 pb-20">
      <div className="flex justify-between items-center shrink-0">
        <div>
          <span className="text-[8px] font-black uppercase text-emerald-600 tracking-wider">Hộp thư hệ thống</span>
